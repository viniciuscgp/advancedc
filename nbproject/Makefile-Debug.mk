...
${OBJECTDIR}/BinaryNumbers.o: BinaryNumbers.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryNumbers.o BinaryNumbers.c

${OBJECTDIR}/BitFields.o: BitFields.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitFields.o BitFields.c

${OBJECTDIR}/BitManipulation.o: BitManipulation.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitManipulation.o BitManipulation.c

${OBJECTDIR}/Bitmasks.o: Bitmasks.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bitmasks.o Bitmasks.c

${OBJECTDIR}/Pointers.o: Pointers.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pointers.o Pointers.c

${OBJECTDIR}/Restrict.o: Restrict.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Restrict.o Restrict.c

${OBJECTDIR}/StringsFunctions.o: StringsFunctions.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringsFunctions.o StringsFunctions.c

${OBJECTDIR}/Testes.o: Testes.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Testes.o Testes.c

${OBJECTDIR}/TypeQualifiers.o: TypeQualifiers.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TypeQualifiers.o TypeQualifiers.c
